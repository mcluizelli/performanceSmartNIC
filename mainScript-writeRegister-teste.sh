...
main(){
    ...
    for CPU in 10 20 30 40 50 60
    do
    mkdir $CPU

    for iRegisterSize in  0 20 40 60 #60 70 80 90 100 # 110 120 130 140 150 160 170 180 190 200
    do
       #register width
       for jRegisterWidth in 32 #64 128 256 512
       do 
