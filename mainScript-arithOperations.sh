...
#reading
    echo "int<64> aux = (int<64>) hdr.intrinsic_metadata.ingress_global_timestamp;" >> $P4FILENAME
    echo "bit<32> auxIndex1 = 128;" >> $P4FILENAME 
#+
    if [ $1 -eq 0 ]
    then
         for i in $(seq $2) 
         do
             echo "aux = aux + " $i ";" >>  $P4FILENAME
         done
    ...
    then
         for i in $(seq $2) 
         do
            echo "auxIndex1 = auxIndex1 / " $i ";" >>  $P4FILENAME
         done
...
configRemoteMachine(){
    ...
    nohup ssh -t root@200.132.136.77 '/opt/MoonGen/build/MoonGen /opt/MoonGen/examples/netronome-packetgen/packetgen.lua -tx 0 -rx 0 --dst-ip 10.1.0.10 --dst-ip-vary 0.0.0.0 --timeout 35 -fp outAux -ps '$size'' & #>/dev/null 
...
main(){
    ...
    for hashType in 0 1 2 3 4 5 6 
    do
       #number of hash function
       for hashNum in  $(seq 11000 1000 30000) #$(seq 5000 5000 100000) # 100000 500000 1000000 5000000 10000000   #0 10 20 30 40 50 100 200 400 600
       do 
